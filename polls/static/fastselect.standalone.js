...
(function(root, factory) {
    ...
    $.extend(Fastselect.prototype, {
        ...
        init: function(inputElement, options) {
            ...
            this.userOptionAllowed = this.isMultiple && this.options.userOptionAllowed;
        ...
        setupSingleElement: function(onDone) {
            ...
            this.$toggleBtn = $('<div>').addClass(this.options.toggleButtonClass).text(toggleBtnText).appendTo(this.$controls);
            this.$queryInput = $('<input>').attr('placeholder', this.options.searchPlaceholder).addClass(this.options.queryInputClass);
            this.$queryInput = this.$toggleBtn;
    ...
    Fastselect.defaults = {
        ...
        toggleButtonClass: 'fstToggleBtn fstQueryInput',
